...
const AppSidebar = () => {
  ...
  const navLinks = {
    student: [
      ...
      { icon: BookOpen, label: "Course", href: "/user/courses" },
    ...
    teacher: [
      { icon: Home, label: "Home", href: "/" },
      { icon: BookOpen, label: "Course", href: "/teacher/courses" },
  ...
  if (!user) return <div>User no found</div>
  ...
  return (
    ...
    >
        ...
        <SidebarMenu className="app-sidebar__menu">
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              className="group transition-all duration-300 hover:bg-customgreys-dirtyGrey"
            >
              <div className="app-sidebar__logo-container group">
                <div className="app-sidebar__logo-wrapper">
                  ...
                  />
                  <p className="app-sidebar__title">COURSENOVA</p>
                </div>
      ...
      <SidebarContent>
        <SidebarMenu className="app-sidebar__nav-item">
